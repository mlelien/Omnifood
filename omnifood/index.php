    ...
    <body>
        <header>
            ...
            <div class="hero-text-box">
                ...
                <a class="btn btn-full js--im-hungry" href="#">I’m hungry</a>
                <a class="btn btn-ghost js--show-me-more" href="#">Show me more</a>
            </div>
        </header>
...
">
        ...
        <section class="section-steps" id="steps">
            ...
            <div class="row">
                ...
                <div class="col span-1-of-2 steps-box">
                    ...
                    <a href="#" class="btn-app"><img src="resources/img/download-app.svg" alt="Link to App Store"></a>
                    <a href="#" class="btn-app"><img src="resources/img/download-app-android.png" alt="Link to Play Store"></a>
                </div>
            </div>
        </section>
                ...
                <div class="col span-1-of-3">
                    <div class="plan-box js--wp-4">
                        <div>
                            ...
                            <p class="plan-price-per-day">That's only $13.30 per meal</p>
                        </div>
                        <div>
                            <ul>
                ...
                <div class="col span-1-of-3">
                    <div class="plan-box">
                        <div>
                            ...
                            <p class="plan-price-per-day">That’s only 14.90$ per meal</p>
                        </div>
                        <div>
                            <ul>
            ...
            <div class="form-box" id="form">
                ...
                <div class="row">
                    <?php
                        ...
                        if ($_GET['success'] == -1) {
                            echo "<div class=\"form-messages error\">Oops! Something went wrong. Pleast try again!</div>";
                        }
                    ?>
                </div>
        ...
        <footer>
            ...
            <div class="row">
                <p>Copyright &copy; 2015 by Omnifood</p>
            </div>
        </footer>
